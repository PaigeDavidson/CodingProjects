...
class cs3430_s24_hw10_uts(unittest.TestCase):
    ...
    #     print('------- test_hw10_prob01_ut03 passed ------------')        

    # def test_hw10_prob01_ut04(self):
    #     print('------- test_hw10_prob01_ut04 ------------')        
    #     a, b, m, n, seed = 214013, 2531011, 4294967296, 20, 11235
    #     lcgg = prng.lcg(a, b, m, n, x0=seed)()
    #     num_rands = 3        
    #     rns = [next(lcgg) for _ in range(num_rands)]
    ...
    #     if self.__check_uniqueness(rns):
    #         print('all random numbers are unique')
    #     print('------- test_hw10_prob01_ut04 passed ------------')            

    # def test_hw10_prob01_ut05(self):
    #     print('------- test_hw10_prob01_ut05 ------------')
    ...
    #     if self.__check_uniqueness(rns):
    #         print('all random numbers are unique')
    #     print('------- test_hw10_prob01_ut05 passed ------------')

    # def test_hw10_prob01_ut06(self):
    #     print('------- test_hw10_prob01_ut06 ------------')
    ...
    #         print('all random numbers are unique')
    #     print('LCG random numbers: {}'.format(rns))
    #     print('------- test_hw10_prob01_ut06 passed ------------')

    # def test_hw10_prob01_ut07(self):
    #     print('------- test_hw10_prob01_ut07 ------------')        
    ...
    #         print('all random numbers are unique')
    #     print('LCG random numbers: {}'.format(rns))            
    #     print('------- test_hw10_prob01_ut07 passed ------------')


    # def test_hw10_prob01_ut08(self):
    #     print('------- test_hw10_prob01_ut08 ------------')        
    ...
    #         print('all random numbers are unique')
    #     print('LCG random numbers: {}'.format(rns))
    #     print('------- test_hw10_prob01_ut08 passed ------------')

    # def test_hw10_prob01_ut09(self):
    #     print('------- test_hw10_prob01_ut09 ------------')
    ...
    #         print('all random numbers are unique')
    #     print('LCG random numbers: {}'.format(rns))            
    #     print('------- test_hw10_prob01_ut09 passed ------------')            

    # def test_hw10_prob01_ut10(self):
    #     print('------- test_hw10_prob01_ut10 ------------')        
    ...
    #     if self.__check_uniqueness(rns):
    #         print('all random numbers are unique')
    #     print('------- test_hw10_prob01_ut10 passed ------------')

    # def test_hw10_prob01_ut11(self):
    #     print('------- test_hw10_prob01_ut11 ------------')
    ...
    #     if self.__check_uniqueness(rns):
    #         print('all random numbers are unique')
    #     print('------- test_hw10_prob01_ut12 passed ------------')            
    ...
    #     if self.__check_uniqueness(rns):
    #         print('all random numbers are unique')
    #     print('------- test_hw10_prob01_ut13 passed ------------')                        

    # def test_hw10_prob01_ut14(self):
    #     print('------- test_hw10_prob01_ut14 ------------')        
    ...
    #     if self.__check_uniqueness(rns):
    #         print('all random numbers are unique')
    #     print('------- test_hw10_prob01_ut14 passed ------------')

    # def test_hw10_prob01_ut15(self):
    #     print('------- test_hw10_prob01_ut15 ------------')        
    ...
    #     if self.__check_uniqueness(rns):
    #         print('all random numbers are unique...')
    #     print('------- test_hw10_prob01_ut17 passed ------------')            

    # def test_hw10_prob01_ut18(self):
    #     print('------- test_hw10_prob01_ut18 ------------')        
    ...
    #     if self.__check_uniqueness(rns):
    #         print('all random numbers are unique...')
    #     print('------- test_hw10_prob01_ut18 passed ------------')                        

    # def test_hw10_prob01_ut19(self):
    #     print('------- test_hw10_prob01_ut19 ------------')                
    ...
    #     if self.__check_uniqueness(rns):
    #         print('all random numbers are unique...')
    #     print('------- test_hw10_prob01_ut21 passed ------------')            


    # ### ================ Problem 02 =================================

    # def test_hw10_prob02_ut01(self):
    #     print('------- test_hw10_prob02_ut01 ------------')        
    #     pim = get_mantissa('pi.txt') 
    #     v, pv = chisquare_str_digit_seq(pim, seq_start=0, seq_end=10)
    #     assert 7.9 < v < 8.1
    #     assert 0.52 < pv < 0.54
    #     print('------- test_hw10_prob02_ut01 passed ------------')                

    # def test_hw10_prob02_ut02(self):
    #     print('------- test_hw10_prob02_ut02 ------------')                
    #     em = get_mantissa('e.txt') 
    #     v, pv = chisquare_str_digit_seq(em, seq_start=0, seq_end=10)
    #     assert 15.9 < v < 16.1
    #     assert 0.05 < pv < 0.07
    #     print('------- test_hw10_prob02_ut02 passed ------------')                        

    # def test_hw10_prob02_ut03(self):
    #     print('------- test_hw10_prob02_ut03 ------------')                        
    #     pim = get_mantissa('pi.txt') 
    #     v, pv = chisquare_str_digit_seq(pim, seq_start=3, seq_end=16)
    #     assert 9.2 < v < 9.4
    #     assert 0.39 < pv < 0.42
    #     print('------- test_hw10_prob02_ut03 passed ------------')                                

    # def test_hw10_prob02_ut04(self):
    #     print('------- test_hw10_prob02_ut04 ------------')                                
    #     em = get_mantissa('e.txt') 
    #     v, pv = chisquare_str_digit_seq(em, seq_start=3, seq_end=16)
    #     assert 9.2 < v < 9.4
    #     assert 0.39 < pv < 0.42
    #     print('------- test_hw10_prob02_ut04 passed ------------')                                        
    
    ### ================ Problem 03 =====================================

    ### I got b/w 80% and 100% on all these tests. 
    def test_hw10_prob03_ut01(self):
        print('--------------- test_hw10_prob03_ut01 ---------------')
        count, percent = chisquare_mersenne_twister(seq_len=5, num_experiments=10)
        print('count   = {}'.format(count))
        print('percent = {}'.format(percent))
        print('--------------- test_hw10_prob03_ut01 passed ---------------')        

    def test_hw10_prob03_ut02(self):
        print('--------------- test_hw10_prob03_ut02 ---------------')        
        count, percent = chisquare_mersenne_twister(seq_len=7, num_experiments=10)
        print('count   = {}'.format(count))
        print('percent = {}'.format(percent))
        print('--------------- test_hw10_prob03_ut02 passed ---------------')                

    def test_hw10_prob03_ut03(self):
        print('--------------- test_hw10_prob03_ut03 ---------------')
    ...
    #     w, h = 30, 30
    #     n = h * w
    #     data = prng.gen_mersenne_twister_data(n, seed=1, option=1)
    ...
    #     w, h = 30, 30
    #     n = h * w
    #     data = prng.gen_mersenne_twister_data(n, seed=1, option=2)
